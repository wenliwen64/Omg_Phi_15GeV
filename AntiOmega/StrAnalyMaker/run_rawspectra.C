void run_rawspectra(){
    ...
    StrAnalyMaker* aMaker = new StrAnalyMaker("AntiOmega");
...
//    aMaker->Init("./0818_overview_11GeV.reweight.histo.root", "./0826_11GeV_omg.local_analysis.root", "./0826_11GeV_omgrot.local_analysis.root");// feng's upstream files
    ...
    std::string fpefffile = "./mcomgbar_fp0.manyeff.histo.root";
    std::string expefffile = "./mcomgbar_exp0.manyeff.histo.root";
