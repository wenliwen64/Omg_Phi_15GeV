...
int cuts_omg_manyptbinseff(int nlist, int block,  string option){
    ...
    std::string filelist;
    if(option == "flat"){
	chain -> Add("./omg_mc_fp.picodst.root");
    }
    else if(option == "exp"){
	chain -> Add("./omg_mc_exp.picodst.root");
    }
    else{
...
*/
    ...
    string ofile_scale;
    if(option == "flat"){
	ofile = "./eff_omg_fp.dat";
	ofile_scale = "./eff_omg_fp_scale.dat";
    }
    else if(option == "exp"){
	ofile = "./eff_omg_exp.dat";
	ofile_scale = "./eff_omg_exp_scale.dat";
    }
    else{
	return -1;
    }
