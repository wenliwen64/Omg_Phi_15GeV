...
int plot_omg(){
    ...
    float pt_bin[6] = {0.4, 1.0, 1.5, 2.0, 2.5, 5.0}; 
...
//=============Plot total result =======================================================
    ...
    hist_total_sig -> Draw("E");
    hist_total_bg -> Draw("sames E");
    canvas_total -> SaveAs("total_mix.png");
    ...
    hist_total_sig -> Draw("E");
    canvas_total_pure -> SaveAs("total_pure.png");
...
//==============Plot Spectra========================================
    ...
    float dpt_spectra[5] = {0.6, 0.5, 0.5, 0.5, 2.5};
    float y_pt_spectra[4][5] = {};
    float y_pt_spectra_cal[4][5] = {};
//calculate the y coordinates of points
    ...
    for(int i = 0; i < 4; i++){
        ...
        for(int j = 0; j < 5; j++){
            ...
            y_pt_spectra_cal_error[i][j] = factor*sqrt(numerator/denominator/denominator + numerator*numerator/denominator); 
    ...
    TCanvas* cpt_omg = new TCanvas("cpt_omg", "cpt_omg", 200, 10, 600, 400);
    cpt_omg -> SetLogy();
    for(int i = 0; i < 4; i++){
    ...
    cpt_omg -> SaveAs("omg_pt_spectra.eps");
    cpt_omg -> SaveAs("omg_pt_spectra.png");
